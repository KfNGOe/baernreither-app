...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: enapso-graphdb-admin.js</title>
...
<body>
    ...
    <div id="main">
        ...
        <h1 class="page-title">Source: enapso-graphdb-admin.js</h1>
        ...
        <section>
            <article>
                <pre class="prettyprint source linenums"><code>// Innotrade enapso Graph Database Admin
// (C) Copyright 2021-2022 Innotrade GmbH, Herzogenrath, NRW, Germany
// Author(s):  Alexander Schulze and Muhammad Yasir
// For further detalils please also refer to the Graph Database admin documentation at: http://localhost:7200/webapi
...
module.exports = EnapsoGraphDBAdmin;
    ...
    <nav>
        ...
        <h3>Classes</h3>
        <ul>
            <li><a href="EnapsoGraphDBAdmin.html">EnapsoGraphDBAdmin</a></li>
        </ul>
    </nav>
    ...
    <footer>
        Documentation generated by <a href="https://github.com/jsdoc/jsdoc">JSDoc 3.6.6</a> on Tue Feb 23 2021 16:55:26
