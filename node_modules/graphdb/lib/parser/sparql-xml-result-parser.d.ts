 ...
 */
declare class SparqlXmlResultParser extends ContentParser {
    parser: SparqlXmlParser;
    /**
...
import { SparqlXmlParser } from "sparqlxml-parse/lib/SparqlXmlParser";
