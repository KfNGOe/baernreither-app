...
//build main
var main_str = fs.readFileSync("assets/txt/editionsrichtlinien.txt", 'utf8');
...
edrichtlinien_html = dom.serialize() ;
console.log('editionsrichtlinien.html =' + LF, edrichtlinien_html) ;

//write html file
//filepath = path_out_tei + filename + ext_xml ;
//console.log(filepath);
fs.writeFileSync('html/editionsrichtlinien.html', edrichtlinien_html ) ;
console.log('html data written: ', edrichtlinien_html.length, ' bytes')
