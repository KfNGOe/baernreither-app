...
cd /home/rh/github/dev-baernreither-app/
...
cp install.sh dl_graphdb.sh gdb_start.sh gdb_ping.sh gdb_createRepo.sh gdb_getRepo.sh /home/rh/github/baernreither-app/
