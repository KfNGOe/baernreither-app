...
export file_rq='annoDate'
export path_out='./data/ttl/anno/anno_web/instance/'
export file_out='annoDatei'
export ext_out='.ttl'
./gdb_queryRepo.sh
...
export path_rq='assets/staticSrc/sparql/'
export file_rq='annoDate_json'
export path_out='./data/json/anno/'
export file_out='annoDate'
export ext_out='.json'
./gdb_queryRepo.sh

echo "build anno date done!"